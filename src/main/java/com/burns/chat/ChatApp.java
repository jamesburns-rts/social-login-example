package com.burns.chat;

import com.burns.chat.config.ApplicationProperties;
import com.burns.chat.config.DefaultProfileUtil;
...
public class ChatApp {
    ...
    public ChatApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ChatApp.class);
