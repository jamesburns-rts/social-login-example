...
public class MessageResource {
     ...
     *
     * @param newMessageVm the messageDTO to create
    ...
    @Timed
    public ResponseEntity<MessageDTO> createMessage(@Valid @RequestBody NewMessageVm newMessageVm) throws URISyntaxException {
        log.debug("REST request to save Message : {}", newMessageVm);
        MessageDTO result = messageService.createMessage(newMessageVm);
    ...
    public ResponseEntity<MessageDTO> updateMessage(@Valid @RequestBody MessageDTO messageDTO) throws URISyntaxException {
        ...
        if (messageDTO.getId() == null) {
            ...
            return ResponseEntity.created(new URI("/api/messages/" + messageDTO.getId()))
                .headers(HeaderUtil.createEntityCreationAlert(ENTITY_NAME, messageDTO.getId().toString()))
                .body(messageDTO);
        }
